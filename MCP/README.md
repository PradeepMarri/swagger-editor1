# Swagger Editor API MCP Server

This MCP (Model Content Protocol) server provides access to Swagger Editor API API functionality through HTTP, HTTPS, and STDIO transport modes.
